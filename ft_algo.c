...
static short    ft_sq_man_dist(short x0, short y0, short x1, short y1)
{
    short res;
...
static char     ft_find_enemy(t_filler *travis, char **map)
{
    short   x;
    short   y;
...
static char     ft_is_in_field(t_filler *travis, short y, short x)
{
